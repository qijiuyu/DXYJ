...
public class AddSupervisionDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取保存的所有数据
        final String SUPERVISION=SPUtil.getInstance(context).getString(SPUtil.SUPERVISION);
        ...
        findViewById(R.id.tv_submit).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                SPUtil.getInstance(context).addString(SPUtil.SUPERVISION, JsonUtil.objectToString(dataBeanList));
                /**
                 * 更新列表页
                 */
