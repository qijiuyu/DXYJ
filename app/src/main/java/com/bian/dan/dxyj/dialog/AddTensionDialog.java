...
import com.bian.dan.dxyj.activity.setting.SupervisionActivity;
import com.bian.dan.dxyj.activity.setting.TensionActivity;
...
public class AddTensionDialog extends Dialog {
    ...
    //要编辑的对象
    private LineAndTension.DataBean editBean;
    //存储所有数据的集合
    private List<LineAndTension.DataBean> dataBeanList = new ArrayList<>();
    //铝管的基本尺寸
    ...
    public AddTensionDialog(Context context, int themeStyle, LineAndTension.DataBean editBean) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取保存的所有数据
        final String TENSION=SPUtil.getInstance(context).getString(SPUtil.TENSION);
        if (!TextUtils.isEmpty(TENSION)) {
            dataBeanList.addAll(JsonUtil.stringToList(TENSION, LineAndTension.DataBean.class));
        }
