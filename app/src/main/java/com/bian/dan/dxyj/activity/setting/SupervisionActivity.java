...
import com.bian.dan.dxyj.dialog.AddSupervisionDialog;
...
public class SupervisionActivity extends BaseActivity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ib_back:
                ...
                break;
            case R.id.tv_add:
                AddSupervisionDialog addDialog = new AddSupervisionDialog(activity, R.style.MyDialog,null);
                addDialog.show();
                break;
            default:
                break;
    ...
    public void showListData(){
        //获取保存的所有数据
        final String SUPERVISION= SPUtil.getInstance(this).getString(SPUtil.SUPERVISION);
        if (!TextUtils.isEmpty(SUPERVISION)) {
            ...
            baseAdapter.setOnItemClickListener(new OnItemClickListener() {
                public void onItemClick(ViewGroup parent, View view, Object o, int position) {
                    AddSupervisionDialog addDialog = new AddSupervisionDialog(activity, R.style.MyDialog, dataBeanList.get(position));
                    addDialog.show();
                }
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(activity)
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    //更新存储的数据
                                    SPUtil.getInstance(activity).addString(SPUtil.SUPERVISION, JsonUtil.objectToString(dataBeanList));
                                }
