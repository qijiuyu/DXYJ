...
import com.bian.dan.dxyj.activity.setting.StraightLineActivity;
...
public class AddStraightLineDialog extends Dialog {
    ...
    public AddStraightLineDialog(Context context, int themeStyle, LineAndTension.DataBean editBean) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取保存的所有数据
        final String STRAIGHT_LINE=SPUtil.getInstance(context).getString(SPUtil.STRAIGHT_LINE);
        if (!TextUtils.isEmpty(STRAIGHT_LINE)) {
            dataBeanList.addAll(JsonUtil.stringToList(STRAIGHT_LINE, LineAndTension.DataBean.class));
        }
