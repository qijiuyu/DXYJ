...
import com.bian.dan.dxyj.activity.setting.ConstructionActivity;
...
public class AddConsDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取保存的所有数据
        final String CONSTRUCTION=SPUtil.getInstance(context).getString(SPUtil.CONSTRUCTION);
        ...
        findViewById(R.id.tv_submit).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                SPUtil.getInstance(context).addString(SPUtil.CONSTRUCTION, JsonUtil.objectToString(dataBeanList));
